...
namespace WordWave.Api.Common.Infrastructure;
...
public static  class QueueFactory
{
    ...
    {
        var factory = new ConnectionFactory() { HostName = WordWaweConstants.RabbitMQHost };
    ...
    public static EventingBasicConsumer EnsureExchange(this EventingBasicConsumer consumer,
                                                       string exchangeName,
                                                       string exchangeType = WordWaweConstants.DefaultExchangeType)
    {
